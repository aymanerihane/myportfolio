  ...
  return (
    <div className="bg-[#0d0d0d] text-white font-[z] w-full h-full relative">
      ...
      <div className="container grid grid-cols-2 h-[calc(100%-120px)] w-full">
          ...
          <div className="side-two flex items-center justify-center px-6 relative">
              <div className="relative blur-3xl w-[400px] h-[400px] bg-gradient-to-r from-[#003366] to-[#00264d] rounded-full ">
              </div>
                  <img 
                    src={myImage} 
                    alt="profile" 
                    className="max-w-[700px] max-h-[700px] w-[300px] h-full absolute bottom-0 flex justify-center object-cover rounded-full" 
                  />
          </div>
      </div>
    </div>
